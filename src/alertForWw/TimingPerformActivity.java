...
public class TimingPerformActivity extends AlarmActivity{
	private TimingAlarm alarm;
	Uri alert;
	Window window;
	...
	protected void onCreate(Bundle savedInstanceState) { 
		...
		alarm = (TimingAlarm)intent.getSerializableExtra("timingAlarm");
		...
		closeAlarmButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				TimingPerformActivity.this.finish();
			}
		});
	}
	@Override
